    ...
    <div class="border">
        ...
        ?>
            <tr>
                ...
                <td><a href="consulter.php?idUser=<?.$arrayUser[$i].?>'" style="color:red; text-decoration: none;"><p> consulter le profil</a></p>'</td>
        ...
        <input type="button" onclick="window.location.href='InscriptionEnfant.php';"value='Créer patient'
                style='background:rgb(101, 137, 244); padding:15px;border-radius: 10px;
                border: rgba(48, 48, 48, 0.5) solid 2px;
                box-shadow: 0px 4px 4px 0px rgba(0,0,0,0.25);'/>
    </div>
